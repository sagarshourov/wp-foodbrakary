			...
			<div class="list-post <?php echo esc_html($featured_class); ?>">
				...
				<div class="delivery-potions">
					...
					?>
	    				...
	    				<div class="time-tooltip">
	    				    <div class="time-tooltip-holder"> <b class="tooltip-label"><?php esc_html_e('Pickup time', 'foodbakery') ?></b>
                                <b class="tooltip-info"><?php printf(esc_html__('You can pickup order in  %s minutes', 'foodbakery'), esc_html($restaurant_pickup_time)); ?></b> </div>
	    				</div>
	    			    </div>
					<?php
				    }
