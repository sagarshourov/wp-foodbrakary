			...
			<div class="text-holder">
				...
				if ($restaurant_pickup_delivery == 'delivery' || $restaurant_pickup_delivery == 'delivery_and_pickup') {
	    			...
	    			<div class="post-time">
	    				...
	    				<div class="time-tooltip-holder"> <b class="tooltip-label"><?php esc_html_e('Delivery time', 'foodbakery') ?></b> 
						<b class="tooltip-info"><?php printf(esc_html__('Your order will be delivered in %s minutes', 'foodbakery'), esc_html($restaurant_delivery_time)); ?></b>
				...
				if ($restaurant_pickup_delivery == 'pickup' || $restaurant_pickup_delivery == 'delivery_and_pickup') {
	    			...
	    			<div class="post-time">
	    			    ...
	    			    <div class="time-tooltip">
	    				<div class="time-tooltip-holder"> <b class="tooltip-label"><?php esc_html_e('Pickup time', 'foodbakery') ?></b> <b class="tooltip-info">
						<?php printf(esc_html__('You can pickup order in  %s minutes', 'foodbakery'), esc_html($restaurant_pickup_time)); ?>
						</b> </div>
	    			    </div>
	    			</div>
				    <?php
			    ...
			    <span class="restaurant-status <?php echo strtolower($status[1]); ?>"><?php echo esc_html__($status[0], 'foodbakery'); ?></span>
			    <?php endif; ?>
			</div>
		    </div>
		</li>
