 ...
 * @package	Foodbakery
 */
if (!class_exists('Foodbakery_buyer_email_invoice_template')) {

    class Foodbakery_buyer_email_invoice_template {
        ...
        public function __construct() {
            ...
            $this->email_template_index = 'buyer-invoice-template';
            ...
            add_action('foodbakery_buyer_invoice_email', array($this, 'foodbakery_buyer_invoice_email_callback'), 11, 1);
        }

        public function foodbakery_buyer_invoice_email_callback($order_id = '') {
            ...
            if (isset($template['email_notification']) && $template['email_notification'] == 1) {
                ...
                $subject = (isset($template['subject']) && $template['subject'] != '' ) ? $template['subject'] : esc_html__('Buyer Invoice', 'foodbakery');
        ...
        function get_order_detail() {
            ...
            if ($order_type == 'order' && is_array($order_menu_list)) {
                ...
                $html .= '<div class="user-order-holder 8">';
    ...
    new Foodbakery_buyer_email_invoice_template();
}
