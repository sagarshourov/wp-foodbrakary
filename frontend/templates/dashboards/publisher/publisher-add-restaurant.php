...
<li>
    <ul class="restaurant-menu-nav nav nav-tabs">
        <li class="active"><a data-toggle="tab"
                href="#menu-cats-items"><?php esc_html_e('Menu Categories', 'foodbakery') ?></a></li>
...
<?php
	...
	public function add_edit_restaurant($params = array()) {
	    ...
	    ?>
<div id="foodbakery-dev-posting-main-<?php echo absint($restaurant_add_counter); ?>" class="user-holder"
    data-ajax-url="<?php echo esc_url(admin_url('admin-ajax.php')); ?>"
    data-plugin-url="<?php echo esc_url(wp_foodbakery::plugin_url()); ?>">
    <?php
		do_action('foodbakery_restaurant_add_meta_save');
		?>
    <form id="foodbakery-dev-restaurant-form-<?php echo absint($restaurant_add_counter); ?>"
        name="foodbakery-dev-restaurant-form" class="foodbakery-dev-restaurant-form"
        data-id="<?php echo absint($restaurant_add_counter); ?>" method="post" enctype="multipart/form-data">
        <?php
			...
			?>
        <ul class="restaurant-settings-nav progressbar-nav" data-restaurant="<?php echo absint($foodbakery_id) ?>"
            data-mcounter="<?php echo absint($restaurant_add_counter) ?>">
            <li data-act="settings" class="<?php echo esc_html($settings_class); ?> cond-restaurant-settings"><a
                    href="javascript:void(0);"
                    data-act="settings"><?php esc_html_e('Restaurant Settings', 'foodbakery'); ?></a></li>
            <li data-act="location" class="<?php echo esc_html($location_class); ?> cond-restaurant-settings"><a
                    href="javascript:void(0);"
                    data-act="location"><?php esc_html_e('Location/Map', 'foodbakery'); ?></a></li>

            <li data-act="openclose" class="<?php echo esc_html($openclose_class); ?> cond-restaurant-settings"><a
                    href="javascript:void(0);"
                    data-act="openclose"><?php esc_html_e('Restaurant Open/Close', 'foodbakery'); ?></a></li>
