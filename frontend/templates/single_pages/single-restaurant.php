        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="page-section restaurant-detail-image-section"
                    <?php echo force_balance_tags($foodbakery_restaurant_cover_styles); ?>>
                    <!-- Container Start -->
                    <div class="container">
                        <!-- Row Start -->
                        <div class="row">
                                ...
                                <div class="company-info-detail">
                                    <div class="company-info">
                                        ...
                                        <div class="text-holder">
                                            ...
                                            <span
                                                class="reviews">(<?php echo($ratings_data['count'] > 0 ? $ratings_data['count'] : 0); ?>
                                                <?php echo esc_html__('Reviews', 'foodbakery'); ?>
                                                )</span>
                                            <?php } ?>
                                            <span
                                                class="restaurant-title"><?php echo esc_html(get_the_title($foodbakery_restaurant_id)) ?></span>
                                            ...
                                            <li>
                                                ...
                                                <ul class="delivery-dropdown" style="display: none;">
                                                    ...
                                                    <li><a href="javascript:void(0)"><span
                                                                class="opend-day"><?php echo $days_array[$opening_hours_single_day_var]; ?></span>
                                                            <span
                                                                class="opend-time close-day"><small>:</small><?php echo esc_html__('Closed', 'foodbakery'); ?></span></a>
                                                    </li>
                                                    <?php
                                                                    }
                                                                }
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-3 col-xs-12 sticky-sidebar">
                                            ...
                                            <div class='filter-wrapper'>
                                                <div class="categories-menu">
                                                    <h6>
                                                        <i
                                                            class="icon-restaurant_menu"></i><?php echo esc_html__('Categories', 'foodbakery') ?>
                                                    </h6>
                                                    <ul class="menu-list">
                                                        <?php
                                                            if ($total_items > 0) {
                                                        ...
                                                        <li class="<?php echo($active_class); ?>"><a
                                                                href="javascript:void(0)" class="menu-category-link"
                                                                data-id="<?php echo absint($menu_loop) ?>">
                                                    ...
                                                    <div id="home"
                                                        ...
                                                        <div class="menu-itam-holder">
                                                            <div class="field-holder sticky-search">
                                                                <input
                                                                    id="menu-srch-<?php echo absint($foodbakery_restaurant_id) ?>"
                                        ...
                                        <div class="sticky-sidebar col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            <div class="user-order-holder">
                                                <div class="user-order">
                                                    <h6>
                                                        <i
                                                            class="icon-shopping-basket"></i><?php esc_html_e('Your Order ', 'foodbakery') ?>
                                                    </h6>
                                                    <?php
                                                    ...
                                                    <div class="select-option dev-select-fee-option"
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <input id="order-delivery-fee" checked="checked"
                                                                    <?php //echo (($show_fee_type == 'delivery') ? 'checked="checked"' : ''); ?>
                                                                    type="radio" name="order_fee_type" value="delivery"
                                                                    ...
                                                                    data-type="delivery" />
                                                                <label
                                                                    for="order-delivery-fee"><?php esc_html_e('Delivery', 'foodbakery') ?></label>
                                                            ...
                                                            <?php
                                                                   // if (($foodbakery_pickup_fee >= 0 ) && ($restaurant_pickup_delivery == 'pickup' || $restaurant_pickup_delivery == 'delivery_and_pickup')) {
                                                                        ...
                                                                        ?>
                                                            <li>
                                                                <input id="order-pick-up-fee" type="radio"
                                                                    <?php //echo (($show_fee_type == 'pickup') ? 'checked="checked"' : '') ?>
                                                                    value="pickup" name="order_fee_type"
                                                                    data-fee="<?php echo foodbakery_get_currency($foodbakery_pickup_fee, false, '', '', false); ?>"
                                                                    data-label="<?php esc_html_e('Pick-Up', 'foodbakery') ?>"
                                                                    data-type="pickup" />
                                                                <label
                                                                    for="order-pick-up-fee"><?php esc_html_e('Pick-Up', 'foodbakery') ?></label>
                                                                           ...
                                                                           // $menu_t_price += floatval($this_item_price);
                                                                            ...
                                                                            ?>
                                                                                <li class="menu-added-<?php echo $rand_numb_class; ?>"
                                                                                    ...
                                                                                    class="item_count_<?php echo $item_count;?>"
                                                                                    ...
                                                                                    <span
                                                                                        class="category-price"><?php echo foodbakery_get_currency($menu_t_price, true, '', '', true); ?></span>
                                                        ...
                                                        <div class="price-area dev-menu-price-con"
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li class="restaurant-fee-con"><span
                                                                    ...
                                                                    <span
                                                                        class="price"><?php echo currency_symbol_possitions_html('<em class="dev-menu-charges"
                                                                ...
                                                                <input type="hidden" id="order_vat_cal_price"
                                                                ...
                                                                <li><?php printf(esc_html__('VAT (%s&#37;)', 'foodbakery'), $foodbakery_payment_vat) ?>
                                                                    <span
                                                                        class="price"><?php echo currency_symbol_possitions_html('<em class="dev-menu-vtax">'.restaurant_menu_price_calc($get_added_menus, $foodbakery_restaurant_id, true, false, true, true).'</em>', foodbakery_get_currency_sign()); ?>
                                                                    </span>
                                                                </li>
                                                                <?php
                                                                        }
                                                    ...
                                                    <div class="pay-option dev-order-pay-options">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <input id="order-cash-payment" value="cash" type="radio"
                                                                    checked="checked" name="order_payment_method"
                                                                    data-type="cash" />
                                                         ...
                                                         <?php
                                                            ...
                                                            ?>            
                                                            <li>
                                                                <input id="order-card-payment" value="card" type="radio"
                                                                    name="order_payment_method" data-type="card" />
                                                    ...
                                                    <a href="javascript:void(0)" class="menu-order-confirm"
                                                        id="menu-order-confirm"
