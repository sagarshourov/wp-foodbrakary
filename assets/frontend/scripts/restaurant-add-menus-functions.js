                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">\n\
                     ...
                     <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">\n\
                        <div class="field-holder">\n\
                            ...
                            <input class="menu-item-extra-title" id="menu_item_extra_title_' + menu_item_counter + '" name="menu_item_extra[' + menu_item_counter + '][' + count_extra_li + '][subtitle][]" type="text" value="" placeholder="subtitle">\n\
                        </div>\n\
                    </div>\n\
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">\n\
                        <div class="field-holder">\n\
